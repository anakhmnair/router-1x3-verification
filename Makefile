...
help:
	...
	@echo "! run_test1	=>  clean, compile & run the simulation for router_small_test in batch mode.			!" 
	@echo "! run_test2	=>  clean, compile & run the simulation for router_med_test in batch mode.			!"
	@echo "! run_test3	=>  clean, compile & run the simulation for router_large_test in batch mode.			!" 
	@echo "! run_test4	=>  clean, compile & run the simulation for router_ssmall_test in batch mode.			!" 
	@echo "! run_test5	=>  clean, compile & run the simulation for router_smed_test in batch mode.			!"
	@echo "! run_test6	=>  clean, compile & run the simulation for router_slarge_test in batch mode.			!" 
	@echo "! view_wave1 =>  To view the waveform of router_base_test	    						!" 
	@echo "! view_wave2 =>  To view the waveform of router_small_test	    						!" 
	@echo "! view_wave3 =>  To view the waveform of router_med_test 	  						!" 
	@echo "! view_wave4 =>  To view the waveform of router_large_test    							!" 
	@echo "! view_wave5 =>  To view the waveform of router_ssmall_test	    						!" 
	@echo "! view_wave6 =>  To view the waveform of router_smed_test 	  						!" 
	@echo "! view_wave7 =>  To view the waveform of router_slarge_test    							!" 
...
run_test1_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH2)  -wlf wave_file2.wlf -l test2.log  -sv_seed random  work.top +UVM_TESTNAME=router_small_test
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov2 
	
run_test2_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH3)  -wlf wave_file3.wlf -l test3.log  -sv_seed random  work.top +UVM_TESTNAME=router_med_test
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov3
	
run_test3_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH4)  -wlf wave_file4.wlf -l test4.log  -sv_seed random  work.top +UVM_TESTNAME=router_large_test
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov4
 
 run_test4_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH5)  -wlf wave_file5.wlf -l test5.log  -sv_seed random  work.top +UVM_TESTNAME=router_ssmall_test
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov5
	
run_test5_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH6)  -wlf wave_file6.wlf -l test6.log  -sv_seed random  work.top +UVM_TESTNAME=router_smed_test
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov6
	
run_test6_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH7)  -wlf wave_file7.wlf -l test7.log  -sv_seed random  work.top +UVM_TESTNAME=router_slarge_test
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov7

run_test7_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH8)  -wlf wave_file8.wlf -l test8.log  -sv_seed random  work.top +UVM_TESTNAME=router_small_test1
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov8 
	
run_test8_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH9)  -wlf wave_file9.wlf -l test9.log  -sv_seed random  work.top +UVM_TESTNAME=router_med_test1
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov9
	
run_test9_Questa:
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH10)  -wlf wave_file10.wlf -l test10.log  -sv_seed random  work.top +UVM_TESTNAME=router_large_test1
